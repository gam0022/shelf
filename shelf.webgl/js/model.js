...
Model.prototype.init = function (contents) {
  ...
  this.ITEM_DATA = [
    [ 1, "bag001-256.jpg", "バルーン型トートバッグ【ネット限定カラーあり】", 3045 ],
    [ 2, "bag002-256.jpg", "一枚合皮のリバーシブルトートバッグ", 3675 ],
    [ 3, "bag003-256.jpg", "軽量２ウェイショルダーバッグ", 3990 ],
    [ 4, "bag004-256.jpg", "ナイロンコンビ３ウェイバッグ", 5990 ],
    [ 5, "bag005-256.jpg", "ラフィアビッグトートバッグ(アンチフォルムデザイン)", 12075 ],
    [ 6, "bag006-256.jpg", "【好評につき、新色追加】シンプルで使いやすい♪ベーシックミニトートバッグ", 1990 ],
    [ 7, "bag007-256.jpg", "ナイロン×レザーツーウェイバッグ(Fascina／ファシーナ)", 9975 ],
    [ 8, "bag008-256.jpg", "本革メッシュバッグ(zucchero filato)", 13650 ],
    [ 9, "bag009-256.jpg", "折りたたみトートバッグ", 1995 ],
    [ 10, "bag010-256.jpg", "仕分けができる９ポケットマザーズバッグ", 5229 ],
    [ 11, "bag011-256.jpg", "２ウェイボストンバッグ(SAC)", 5145 ],
    [ 12, "bag012-256.jpg", "メッシュショルダーバッグ", 2990 ],
    [ 13, "bag013-256.jpg", "１０ポケット２ウェイバッグ(ディズニー)", 4990 ],
    [ 14, "bag014-256.jpg", "多機能マルチショルダーバッグ(ディズニー)", 4990 ],
    [ 15, "bag015-256.jpg", "切り替えカラートートバッグ(マリ・クレール)", 12600 ],
    [ 16, "bag016-256.jpg", "セミショルダーバッグ", 3990 ],
    [ 17, "bag017-256.jpg", "２ウェイセミショルダーバッグ(mini labo)", 2932 ],
    [ 18, "bag018-256.jpg", "メタリック合皮使い２ウェイショルダーバッグ", 4990 ],
    [ 19, "bag019-256.jpg", "ツーウェイワンショルダーバッグ(フィッチ)", 8190 ],
    [ 20, "bag020-256.jpg", "パンチング手提げバッグ(ラメットベリー)", 7980 ],
    [ 21, "bag021-256.jpg", "ショルダーバッグ(ディズニー)", 4990 ],
    [ 22, "bag022-256.jpg", "綿麻トートバッグ", 3990 ],
    [ 23, "bag023-256.jpg", "折りたたみビッグトートバッグ(ディズニー)", 2990 ],
    [ 24, "bag024-256.jpg", "花柄トートバッグ", 9870 ],
    [ 25, "bag025-256.jpg", "花柄バッグ", 9450 ],
    [ 26, "bag026-256.jpg", "レザーツーウェイバッグ", 9990 ],
    [ 27, "bag027-256.jpg", "ディパック(コールマン)", 4980 ],
    [ 28, "bag028-256.jpg", "２ウェイがま口バッグ(ディズニー)", 4990 ],
    [ 29, "bag029-256.jpg", "メッシュトートバッグ(デラクラッセ)", 7980 ],
    [ 30, "bag030-256.jpg", "レザーワンショルダーバッグ", 9990 ],
    [ 31, "bag031-256.jpg", "デイバッグ／トートバッグ(キャスキッドソン／Cath Kidston)", 7875 ],
    [ 32, "bag032-256.jpg", "デイバッグ／トートバッグ(キャスキッドソン／Cath Kidston)", 7875 ],
    [ 33, "bag033-256.jpg", "トートバッグ(Fascina／ファシーナ)", 5985 ],
    [ 34, "bag034-256.jpg", "セミショルダーバッグ(デラクラッセ)", 7980 ],
    [ 35, "bag035-256.jpg", "レザートートバッグ(Lucca Italy／ルカ イタリー)", 10500 ],
    [ 36, "bag036-256.jpg", "レーザーカットトートバッグ", 4990 ],
    [ 37, "bag037-256.jpg", "２ウェイマルチトートバッグ(mini labo)", 5990 ],
    [ 38, "bag038-256.jpg", "ナイロンコンビ２ウェイバッグ", 4990 ],
    [ 39, "bag039-256.jpg", "お受験バッグ", 2990 ],
    [ 40, "bag040-256.jpg", "異素材コンビトートバッグ", 5990 ],
    [ 41, "bag041-256.jpg", "レザーツーウェイバッグ", 15750 ],
    [ 42, "bag042-256.jpg", "３ポケット２ウェイショルダーバッグ", 3990 ],
    [ 43, "bag043-256.jpg", "セミショルダーバッグ", 3990 ],
    [ 44, "bag044-256.jpg", "メッシュショルダーバッグ(ディズニー)", 3990 ],
    [ 45, "bag045-256.jpg", "ショルダーバッグ(adidas/アディダス)", 2572 ],
    [ 46, "bag046-256.jpg", "折りたたみ収納可能なナイロントートバッグ(ユナイテッドカラーズオブベネトン)", 2980 ],
    [ 47, "bag047-256.jpg", "２ウェイショルダーバッグ(SAC)", 5145 ],
    [ 48, "bag048-256.jpg", "カジュアルジムバッグ", 4990 ],
    [ 49, "bag049-256.jpg", "小ぶりな異素材コンビ手さげバッグ", 3990 ],
    [ 50, "bag050-256.jpg", "デイパック(SAC)", 5145 ],
    [ 51, "bag051-256.jpg", "ムラシワ合皮２ウェイバッグ", 6195 ],
    [ 52, "bag052-256.jpg", "三角形フォルムのショルダーバッグ", 4990 ],
    [ 53, "bag053-256.jpg", "ツーウェイバッグ(マリ・クレール)", 16800 ],
    [ 54, "bag054-256.jpg", "３室構造のショルダーバッグ", 4990 ],
    [ 55, "bag055-256.jpg", "トートバッグ(ディズニー)", 3990 ],
    [ 56, "bag056-256.jpg", "ジムバッグ(ディズニー)", 4990 ],
    [ 57, "bag057-256.jpg", "パッカブルボストンバッグ(le coq sportif／ルコックスポルティフ)", 1995 ],
    [ 58, "bag058-256.jpg", "チャーム付きセミショルダーバッグ(SAC)", 6195 ],
    [ 59, "bag059-256.jpg", "リュックにもなる２ウェイショルダーバッグ", 4990 ],
    [ 60, "bag060-256.jpg", "フェルト刺しゅう手提げバッグ", 1428 ],
    [ 61, "bag061-256.jpg", "ブックトート／トートバッグ(キャスキッドソン／Cath Kidston)", 3307 ],
    [ 62, "bag062-256.jpg", "２ウェイショルダーバッグ", 5990 ],
    [ 63, "bag063-256.jpg", "２ウェイショルダーバッグ／１２５６０(ヴェラ ブラッドリー／Vera Bradley)", 5512 ],
    [ 64, "bag064-256.jpg", "ミニバッグ(ルコック)", 1050 ],
    [ 65, "bag065-256.jpg", "レザートートバッグ", 9990 ],
    [ 66, "bag066-256.jpg", "通勤フィットネスバッグ（中）", 4590 ],
    [ 67, "bag067-256.jpg", "トートバッグ", 3990 ],
    [ 68, "bag068-256.jpg", "パンチングレザーツーウェイバッグ(ラメットベリー)", 13650 ],
    [ 69, "bag069-256.jpg", "２ウェイナイロンバッグ", 2352 ],
    [ 70, "bag070-256.jpg", "大容量！軽くて使いやすいピンドットボストンバッグ", 980 ],
    [ 71, "bag071-256.jpg", "口金セミショルダーバッグ(デザインファクトリー)", 5145 ],
    [ 72, "bag072-256.jpg", "手提げバッグ(帆布工房)", 3990 ],
    [ 73, "bag073-256.jpg", "メッシュトートバッグ(ディズニー)", 4990 ],
    [ 74, "bag074-256.jpg", "ＨＩＰＨＵＲＲＡＹ／手提げバッグ／１１２７６(キプリング／Kipling)", 2940 ],
    [ 75, "bag075-256.jpg", "ガーメントケース", 3990 ],
    [ 76, "bag076-256.jpg", "軽くてたっぷり入るトラベルボストンバッグ", 1290 ],
    [ 77, "bag077-256.jpg", "ハードキャリーバッグ（大）", 13990 ],
    [ 78, "bag078-256.jpg", "ミニドラムショルダー(ＲＯＸＹ／ロキシー)", 3990 ],
    [ 79, "bag079-256.jpg", "スパンコールのキラキラでゴージャス感たっぷり☆手提げバッグ(デザインファクトリー)", 3045 ],
    [ 80, "bag080-256.jpg", "コンパクト収納　ボストンバッグ(ルコック)", 1995 ],
    [ 81, "bag081-256.jpg", "カジュアルジムバッグ", 4990 ],
    [ 82, "bag082-256.jpg", "ダブルジップバッグ／ショルダーバッグ(キャスキッドソン／Cath Kidston)", 8268 ],
    [ 83, "bag083-256.jpg", "オープンキャリオール／トートバッグ(キャスキッドソン／Cath Kidston)", 4567 ],
    [ 84, "bag084-256.jpg", "ローズポーチ付きトートバッグ", 7980 ],
    [ 85, "bag085-256.jpg", "２ウェイボストンバッグ(ディズニー)", 5990 ],
    [ 86, "bag086-256.jpg", "キャリーケース（大）(ディズニー)", 18690 ],
    [ 87, "bag087-256.jpg", "母の日　軽量ポケットいっぱい多機能バッグ", 3990 ],
    [ 88, "bag088-256.jpg", "ポーチ付き軽量でＡ４も入り通勤にお役立ち☆２ウェイトートバッグ(ＳＡＣ／サック)", 4095 ],
    [ 89, "bag089-256.jpg", "ボストンバッグ“オールラウンダーＭ”(ライゼンタール)", 3465 ],
    [ 90, "bag090-256.jpg", "レザー手提げバッグ", 9990 ],
    [ 91, "bag091-256.jpg", "たためるビックエコバッグ(ディズニー)", 1990 ],
    [ 92, "bag092-256.jpg", "キャリーケース(ROXY／ロキシー)", 12316 ],
    [ 93, "bag093-256.jpg", "ツーウェイバッグ(ラメットベリー)", 3591 ],
    [ 94, "bag094-256.jpg", "コーティングトートバッグ(ディズニー)", 4990 ],
    [ 95, "bag095-256.jpg", "レディスフォーマルバッグ", 6990 ],
    [ 96, "bag096-256.jpg", "ボストンバッグ／１２４７９(ヴェラ ブラッドリー／Vera Bradley)", 8820 ],
    [ 97, "bag097-256.jpg", "ヴィンテージ／ランチトート／ＨＢ１Ｐ０１９(フォリフォリ／Folli Follie)", 5775 ],
    [ 98, "bag098-256.jpg", "収納上手さんにオススメ☆２ウェイトートバッグ(ＳＡＣ／サック)", 6195 ],
    [ 99, "bag099-256.jpg", "ショッパーＭ(ライゼンタール)", 1575 ],
    [ 100, "bag100-256.jpg", "チェックウエストポーチ", 1596 ]
      ];
